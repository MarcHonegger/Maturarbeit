...
\begin{enumerate}
    \item \textbf{Zeit} \\
        Geplant war ungefähr eine Lektion pro Woche. Wir haben die geschätzten 100 Stunden (50 Stunden pro Person) um einen Faktor von drei überschritten. Unser gemessener Zeitaufwand, während aktivem Programmieren,
...
\subsection{Notwendig}
    ...
    \item \textbf{Synchronisation} \\
        ...
        erneut gesendet. Dies hilft uns dabei, die Synchronisation zu jeder Zeit aufrecht zu erhalten.
