...
\subsection{Notwendig}
    ...
    \begin {itemize}
        ...
        \item \textbf{Settings}\\
            Man kann hier die Auflösung ändern und auswählen, ob das Spiel im Vollbild dargestellt werden soll. Auch gibt es hier die Möglichkeit, die Musik lauter oder leiser zu stellen
            oder zu muten. Wenn man die Einstellungen geändert hat, kann man die Änderungen mit einem Mausklick speichern. 
            \begin{figure}[H]
                \centering
        ...
        \item \textbf{InGame-UI}\\
            ...
            %\end{center}
            Im Einstellungsmenu während des Spiels kann man ausserdem leicht die Musiklautstärke und die Stärke des Schneefalls ändern. Dieses Menu kann mit ESC geöffnet und geschlossen werden.
            \begin{figure}[H]
                \centering
                \includegraphics[height=4cm]{resources/pause.png}\\
                \caption{Ingame Einstellungsmenu}
            \end{figure}
    ...
    \item \textbf{Kamera} \\
        Die Kamera ist beweglich und das ganze Schlachtfeld ist sichtbar. Mit den Pfeiltasten kann man die Kamera frei bewegen und hinein- bzw. herauszoomen.
    \item \textbf{Truppen} \\
        Folgend sind alle im Moment implementieren Truppen zu sehen.
        Es ist jeweils der Angriffstyp mit einem Symbol (Nahkampf: Schwert, Fernkampf: Bogen, Suizid: Feuer), ihr Maximalesleben oben rechts und ihre Kosten oben links angegeben.
        Die Werte sind eventuell nicht die exakt gleichen wie im Spiel. \\
        \includegraphics[width=3cm]{resources/Skeleton.png}
        \includegraphics[width=3cm]{resources/Striker.png}
        \includegraphics[width=3cm]{resources/Enforcer.png}
        \includegraphics[width=3cm]{resources/Mushroom.png}\\
        \includegraphics[width=3cm]{resources/Ronin.png}
        \includegraphics[width=3cm]{resources/Archer.png} 
        \includegraphics[width=3cm]{resources/Prototype.png} 
        \includegraphics[width=3cm]{resources/King.png} \\
    ...
    \item \textbf{Lanes} \\
        Unser Spiel hat vier sogenannte Linien (''Lanes''). Diese unterschiedlichen Linien wurden in der Tiefe nach hinten verschoben. Der*die Spieler*in hat die Auswahl, in welcher Reihe er*sie sein*ihre Truppen auf den Gegner zuschicken will.
...
\begin{itemize}
    ...
    \item \textbf{Truppen} \\
        ...
        Wir haben alle Funktionen mit dem Hintergedanken geschrieben, dass es jederzeit ohne grössere Anpassungen möglich ist, neue Truppen hinzuzufügen.
\end{itemize}
...
\begin{itemize}
    ...
    \end{enumerate}
    \item \textbf{Zauber} \\
        Wir hatten bereits zu einem frühen Zeitpunkt eine funktionierende Testversion. Der Zauber wurde dem*der Spieler*in als eine Karte verteilt. \\
