...
Eine Visualisierung von unserem \gls{GitHub Repository} kann man unter folgendem \href{https://youtu.be/3uPTdjVXtNk}{Link} finden.
...
Gource ist eine gratis open-source Software, die perfekt für die Visualisierung von GitHub Repositories geeignet ist. Wir haben Gource für die Erstellung eines Videos genutzt, das als \href{https://youtu.be/3uPTdjVXtNk}{Visualisierung unseres Dateisystems}
dient.
