...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        eigenen Animator haben. In diesem kann man verschieden Zuständen des Spielobjekts verschiedene Animationen zuweisen. Greift die Truppe zum Beispiel an, wird von der normalen Animation zur Angriffs-Animation
        gewechselt.  
    \end{itemize}
    \item Programmierung
    \begin{itemize}
...
Ein sehr grosser Vorteil von GitHub ist, dass man im Team in Echtzeit am gleichen Code schreiben kann. Unser grösste Pro-Argument: Backup-Backup-Backup!
