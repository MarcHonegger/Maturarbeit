...
\begin{enumerate}
    ...
    \item \textbf{Möglichkeiten:}
        Dies sind Möglichkeiten, den Spielspass auf ein neues Hoch zu heben. Keine dieser Anforderungen ist für das Spielen nötig,
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item[-] Wenig Nutzen und sehr aufwendig. Neue Designs zu erstellen, wäre bei uns nicht so sinnvoll.
